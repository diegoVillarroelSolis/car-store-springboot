...
public class SubjectController {
    ...
    public void updateSubject(@PathVariable String id, @RequestBody RequestSubjectDTO updatedSubjectDTO){
        subjectService.updateSubject(id, updatedSubjectDTO);
    }

    @RequestMapping(method = RequestMethod.PATCH, value = "/{id}")
    public void update(@PathVariable String id, @RequestBody RequestSubjectDTO updatedSubjectDTO){
        subjectService.updateSubject(id, updatedSubjectDTO);
    }
